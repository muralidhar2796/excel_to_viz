			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ExcelToViz-display": {
								"semanticObject": "ExcelToViz",
								"action": "display",
								"description": "SAPUI5 Application that takes Excel and Input and displays VIZ Charts",
								"title": "Excel To Viz",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exceltoviz",
									"url": sap.ui.require.toUrl("exceltoviz")
								}
							}
						}
					}
